    ...
    <div id="pageWrapper">
        ...
        <main>
            ...
            <aside class="tryPetAside text-center text-white py-5 py-lg-8 wow pulse">
                <div class="container">
                    <p class="mb-0">Ready to get started? It's fast, free and very easy! <a href="#scrollTo6"
            ...
            <section id="scrollTo6" class="introBlock d-flex w-100 position-relative text-white">
                <div class="w-100 d-flex align-items-center">
                    <!-- ibHolder -->
                    <div class="w-100 position-relative ibHolder py-19 py-md-23 py-xl-29">
                        <div class="container">
                            <div class="row d-flex justify-content-center align-items-center">
                                <div class="text-center" style="z-index:3">
                                    ...
                                    <p style="color:gray">Automatically capture meeting notes.</p>
                                </div>
